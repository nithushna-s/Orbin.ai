      ...
      <Container>
        ...
        <Row className="align-items-center">
          <Col md={6}>
            ...
            <p>
              At Orbin.ai
, our mission is to leverage artificial intelligence to create innovative solutions that empower businesses to thrive in the digital age. We are committed to driving progress and efficiency through cutting-edge technology.
            </p>
            <h3>Our Vision</h3>
            <p>
