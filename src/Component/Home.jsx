      ...
      <section id="home" className="home-section d-flex align-items-center">
        <Container>
          <Row className="justify-content-center text-center">
            <Col md={10} lg={8}>
              <h1 className="display-4">Welcome to Orbin.ai
</h1>
              <p className="lead">
        ...
        <Container>
          <Row className="justify-content-center text-center">
            <Col md={10} lg={8}>
              ...
              <p className="lead">
                Orbin.ai
 is at the forefront of AI innovation. We specialize in providing bespoke AI solutions that empower businesses to achieve new heights. Our team of experts is dedicated to delivering technology that drives progress and success.
              </p>
            </Col>
          </Row>
        </Container>
